...
function Section (){
    ...
    function toggleText() {
        var x = document.getElementsByClassName(".divsec1");
    ...
    return(
     ...
     <div className="home">
             {/* <div className="nav">
                 ...
                 <a exact to="/ " className="links ln2">home</a>
                 <a  to="/menu" className="links">menu</a>
                 <a  to="/our" className="links">our story</a>
                 <a  to="/contact" className="links">contact us</a>
                 <form>
             ...
             <div className="button1">
                 ...
                 <button className="buttonces1" onClick={toggleText}><b>read more</b></button>
             </div>
